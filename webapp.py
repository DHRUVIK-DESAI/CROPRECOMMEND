...
import bz2
import pandas as pd
st.set_page_config(page_title="Crop Recommendation", page_icon="PHOTO.jpg", layout="centered", initial_sidebar_state="auto", menu_items=None)
...
def set_bg_hack_url():
    ...
    st.markdown(
            <style>
          .stApp {{
              background: url("https://www.thetatva.in/wp-content/uploads/2020/12/178976-farmerweb.jpg");
